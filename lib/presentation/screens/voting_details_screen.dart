...
class _VotingDetailsViewState extends State<_VotingDetailsView> {
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        actions: <Widget>[
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(backgroundColor: AppTheme.rudnGreenColor),
  ...
  Widget build(BuildContext ctxt) {
    ...
    final statusColor = widget.event.hasVoted ? AppTheme.rudnGreenColor : AppTheme.rudnRedColor;
                  ...
                  children: [
                    NestedScrollView(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: const BoxDecoration(
                                            ...
                                            borderRadius: BorderRadius.only(
                                              ...
                                              bottomLeft: Radius.circular(26), // Match bottom corner
                                            ),
                                          ),
                                          child: Text(
                      ...
                      body: ListView.builder(
                        padding: EdgeInsets.fromLTRB(0, 8, 0, bottomPadding), // Remove side padding as window is padded
                        itemCount:
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.symmetric(vertical: 16),
                            backgroundColor:
                          widget.event.hasVoted ? Colors.grey : AppTheme.rudnGreenColor,
                          ),
                          onPressed: (state is VotingLoadInProgress ||
                                  _selectedAnswers.isEmpty ||
                                  widget.event.hasVoted)
